...
<template>
    <div v-if="!showNextPage" class="flex flex-col gap-8 mt-5 max-w-3xl items-center">
        ...
        <form class="max-w-sm mx-auto">
            <input v-model="number"  type="number" id="number-input" class="bg-gray-50 outline-none text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="5" min="1" max="10" required />
        </form>
